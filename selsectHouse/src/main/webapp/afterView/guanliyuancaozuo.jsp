...
<script type="text/javascript">
    ...
    function addRow(){
        ...
        c5.innerHTML ='<input type="button" value="删除" class="del"/><input type="button" value="修改" class="update"/>';
...
<div id="Wuc_header_header00" class="header header00 top00">
    <img src="/selsectHouse/afterView/img/topimg00.jpg">
        ...
        <div class="content">
            <div class="bgwhite  mag_tb">
                ...
                <div>
                    <div class="xmgs_tab">
                        <a href="/selsectHouse/afterView/yonghuxinxiguanli.jsp">
                        ...
                        <a href="/selsectHouse/afterView/xiaoshouxinxiguanli.jsp">
                        <span data-id="6" class="xmgsyabHover" >销售信息管理<font></font></span>
                        </a>
                        ...
                        <a href="/selsectHouse/afterView/shouye.jsp">
   ...
   <!-- --------------------------------------------------------------------------------------------------- -->                 
     ...
     <form action="staffQuery.do" method="post">                 
     <table id="stuRecordTable" border="1" cellpadding="0" cellspacing="0" class=".caq_tbts2">
        <tr>
            <th>姓名</th>
