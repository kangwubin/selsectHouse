    ...
    <img src="/selsectHouse/afterView/img/topimg005.jpg">
        ...
        <div class="content bgwhite  sfyzDiv">
		 ...
		 <form action="/selsectHouse/LoginServlet?method=staffLogin" method="post">
                ...
                <table>
                    <tbody><tr>
                        <td class="size16 tr" width="164">用户名&nbsp;</td>
                        <td class="checkinput" colspan="2" width="300">
                            <input name="txtXm" type="text" id="txtXm" class="bs lh_30 ti" datatype="/^[\u2e80-\ufe4f\ufa2d\a-zA-Z_\.·\s+]{2,20}$/" placeholder="请输入员工用户名" nullmsg="员工用户名不能为空！" errormsg="请输入正确员工用户名！" sucmsg=" " maxlength="50"></td>
                        <td class="prel">
