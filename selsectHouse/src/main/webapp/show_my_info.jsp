	...
	<div class="content bgwhite  sfyzDiv">
		...
		<div class="bd bgFDF8EA prel pad_20 mag_t80 sfrzTip">
			<div class="size18 color_e34156" align="center">
				友情提示：1.请确认您的信息是否正确，点击确认提交之后，个人信息将不可更改......<br>2.请记住您的密码，以便下次登录.......
			</div>
		</div>
		<div align="center">
			<div align="center">
				...
				<form>
					...
					<table width="1000" border="1" align="center" cellpadding="10"
						cellspacing="10">
						<tr>
							<td width="100">姓名：</td>
							<td width="200"><label for="textfield"></label> <input
								type="text" name="textfield" id="textfield"
								value="<%=purchaser.getREALNAME()%>" readonly="readonly" /></td>
							<td>证件类型：</td>
							<td><input type="text" name="card_type" id="textfield4"
								placeholder="证件类型" readonly="readonly"
								value="<%=purchaser.getCARDTYPE()%>" /></td>
						</tr>

						<tr>
							<td>证件号码：</td>
							<td><label for="textfield2"></label> <input type="text"
								name="textfield2" id="textfield2" placeholder="18位数字"
								readonly="readonly" value="<%=purchaser.getCARDCODE()%>" /></td>
							<td>电话号码：</td>
							<td><label for="textfield3"></label> <input type="text"
								name="textfield3" id="textfield3" placeholder="11位数字"
								value="<%=purchaser.getMOBILEPHONE()%>" /></td>
						</tr>

						<tr>
							<td>购房类型：</td>
							<td><input type="text" name="family_type" id="textfield4"
								placeholder="购房类型" readonly="readonly"
								value="<%=purchaser.getPURCHASETYPE()%>" /></td>
							<td>密码：</td>
							<td><label for="textfield4"></label> <input type="text"
								name="textfield4" id="textfield4" placeholder="8-15位"
								value="<%=purchaser.getPASSWORD()%>" /></td>
						</tr>
					</table>
