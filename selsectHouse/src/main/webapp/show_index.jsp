			...
			<div>
				<div class="xmgs_tab">
					<a href="./show_index.jsp"> <span data-id="-1"
						class="xmgsyabHover2">意向登记公示<font></font></span>
			...
			<div class="mag_b10 prel pad_10 pad_t25">
				...
				<div class="prel xmmcSearchDiv">
					<span class="mag_r10">项目名称</span> <input class="xmmcSearch"
						type="text" value="" id="txtSearch" onkeypress="">
					<div class="xmgs_searchBtn" onclick="">搜索</div>
					<!-- <div id="divDayDjsj" class="pab right_20 size14 top_8 color_999999">登记时间为：08:00-18:00</div> -->
				</div>
			</div>
			<div class="grayLine"></div>
			<table class="tab" width="1200" cellpadding="0" cellspacing="0"
				class="a">
				<tbody>
					<tr>
						<td align="center" bgcolor="#e7e3e3"><table width="1200"
								...
								<tbody>
									<tr>
										...
										<td align="center" bgcolor="#e7e3e3"><span class="fb">用户姓名</span></td>
										<td align="center" bgcolor="#e7e3e3" colspan="2"><span
											class="fb">身份证号</span></td>

										<td align="center" bgcolor="#e7e3e3"><span class="fb">联系方式</span></td>
										<td align="center" bgcolor="#e7e3e3"><span class="fb">是否无房家庭</span></td>
										<td align="center" bgcolor="#e7e3e3"><span class="fb">审核状态</span></td>
									...
									<%
									Purchaser pur = (Purchaser) request.getAttribute("purchaser");
									if (pur != null ) {
									%>
									<tr>
										...
										<td align="center"><%=pur.getMOBILEPHONE() %></td>
